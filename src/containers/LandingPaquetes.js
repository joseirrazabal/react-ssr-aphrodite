...
import FlightItineraryResumen from 'Maurio/lib/Organisms/FlightItinerary/FlightItineraryResumen'
import ImageBookPaquetes from 'Maurio/lib/Organisms/ImageBook/ImageBookPaquetes'
import FechasCard from 'Maurio/lib/Molecules/Card/FechasCard'
    ...
    return (
      ...
      <div>
                  ...
                  <DesplegableContentCard
                    ...
                    content={
                      <ul style={{ padding: 0 }}>
                        ...
                        <li>08 noches de alojamiento con régimen all inclusive</li>
        ...
        >
          ...
          <DialogActions>
            <Button text="Consultar" border onClick={this.handleClose} color="primary" />
...
export default withMobileDialog()(withStyles(({ mauri: { color, variables, flexColumn, marginT40, marginT20, simpleFlex, paddingBox, paddingObject, padding10, containerlg } }) => ({
  noWrapper: {
    overflowX: 'scroll',
    background: '#f2f2f2',
    padding: 10,
