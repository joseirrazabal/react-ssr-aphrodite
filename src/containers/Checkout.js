...
import SteppersCheckout from 'Maurio/lib/Templates/Checkout/SteppersCheckout'
import { css, withStyles, withStylesPropTypes } from "react-with-styles"
import { TitleSecondary, TitleH3, Text } from 'Maurio/lib/Atoms/TitleLabel/TitleLabel'
import Grid from 'material-ui/Grid'
import Resumen from 'Maurio/lib/Templates/Checkout/Resumen'
                      ...
                      calculatedHeight
                        ...
                        <div style={{
                          ...
                          <Expander
                            expansion={true}
                            title={
                              <div {...css(styles.flexStartEnd, { width: '100%' }) }>
                                <div>
                            ...
                            content={
                              <div style={{ width: '100%' }}>
                                <div {...css(styles.flexStartEnd, styles.itemsResumen, { width: '100%' }) }>
                                  <div>
...
export default withMobileDialog()(withStyles(({ mauri: { color, variables, containerCheckout, flex, flexStartEnd, paddingBox } }) => ({
  containerCheckout,
  paddingBox,
  flex,
  flexStartEnd,
