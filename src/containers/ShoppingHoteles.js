...
import FiltersHotelsMobile from 'Maurio/lib/Atoms/Filters/FiltersHotelsMobile'
import SlideCard from 'Maurio/lib/Molecules/Card/SlideCard'
import LoadingCard from 'Maurio/lib/Molecules/Card/LoadingCard'
...
import SmallSearch from 'Maurio/lib/Organisms/Search/SmallSearch'
...
import FilterList from 'Maurio/lib/Molecules/List/FilterList'
      ...
      <Grid>
        ...
        <section {...css(styles.marginTop) }>
          <Grid container spacing={0}>
            ...
            <Grid container spacing={0} xs={12} sm={12} lg={8} xl={7} {...css(styles.contentResult) }>
