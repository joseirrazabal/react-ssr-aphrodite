...
import SearchShoppingVuelos from "Maurio/Organisms/Search/SearchShoppingVuelos";
import FlightItinerary from "Maurio/Organisms/FlightItinerary/FlightItinerary";
import LoadingFlight from "Maurio/Organisms/FlightItinerary/LoadingFlight";
    ...
    return (
      <Grid>
            ...
            >
              <div {...css(styles.searchFilter)}>
                <Grid container spacing={10}>
                  ...
                  <Grid
                    xs={12}
                    {...css(styles.flexBox, styles.filterPc, { marginTop: 10 })}
                  >
        ...
        >
          ...
          <DialogActions
            style={{ background: "#f2f2f2", margin: 0, padding: 10 }}
          >
            <Button
